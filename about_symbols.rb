...
class AboutSymbols < Neo::Koan
  ...
  # A: there is always only 1 behind the scene so you can only test against the string to assert the value is something you expect
  ...
  # symbols are very efficient for keys and hashes - especially if you will use them until the program ends
end
